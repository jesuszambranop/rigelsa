(function () {
  ...
  var superficiesTinta = [
    { ruta: "assets/superficies/codificacion-caja-carton.webp", es: "Caja de cartón", en: "Cardboard box", altEs: "Caja de cartón con referencia, lote y código QR impresos", altEn: "Cardboard box printed with reference, batch number and QR code" },
    { ruta: "assets/superficies/codificacion-frasco-vidrio.webp", es: "Frasco de vidrio", en: "Glass bottle", altEs: "Frasco de vidrio con fecha y lote impresos", altEn: "Glass bottle printed with date and batch number", soloVidrio: true },
    { ruta: "assets/superficies/codificacion-envase-plastico.webp", es: "Envase plástico", en: "Plastic container", altEs: "Envase plástico con fecha y lote impresos", altEn: "Plastic container printed with date and batch number" },
    { ruta: "assets/superficies/codificacion-lata-aluminio.webp", es: "Lata de aluminio", en: "Aluminum can", altEs: "Lata de aluminio con fecha y lote impresos", altEn: "Aluminum can printed with date and batch number" },
    { ruta: "assets/superficies/codificacion-cable-plastico.webp", es: "Cable plástico", en: "Plastic cable", altEs: "Cable plástico con fecha y lote impresos", altEn: "Plastic cable printed with date and batch number" },
    { ruta: "assets/superficies/codificacion-madera.webp", es: "Madera", en: "Wood", altEs: "Pieza de madera con fecha y lote impresos", altEn: "Wood surface printed with date and batch number" },
    { ruta: "assets/superficies/codificacion-empaque-metalizado.webp", es: "Empaque metalizado", en: "Foil pouch", altEs: "Empaque metalizado con fecha y lote impresos", altEn: "Foil pouch printed with date and batch number" }
  ];
  ...
  function seccionSuperficiesTinta(producto) {
    if (producto.tipo !== "Tinta" && producto.tipo !== "Ink") return "";
    var existeSk11 = productos.some(function (item) { return String(item.modelo).toUpperCase() === "SK11"; });
    var modeloVidrio = existeSk11 ? "SK11" : "SK10";
    var superficies = superficiesTinta.filter(function (superficie) {
      return !superficie.soloVidrio || String(producto.modelo).toUpperCase() === modeloVidrio;
    });
    return '<section class="contenedor superficies-tinta" aria-labelledby="titulo-superficies-tinta"><h2 id="titulo-superficies-tinta">' + (lang === "es" ? "Superficies de impresión" : "Printing surfaces") + '</h2><div class="superficies-tinta-rejilla" style="--cantidad-superficies:' + superficies.length + '">' + superficies.map(function (superficie) {
      var nombre = lang === "es" ? superficie.es : superficie.en;
      var alt = lang === "es" ? superficie.altEs : superficie.altEn;
      return '<figure class="superficie-tinta"><div class="superficie-tinta-imagen"><img src="' + superficie.ruta + '" alt="' + escaparAtributo(alt) + '"' + atributosImagen(superficie.ruta) + ' loading="lazy" decoding="async"></div><figcaption>' + nombre + '</figcaption></figure>';
    }).join("") + '</div></section>';
  }
